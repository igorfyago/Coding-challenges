...
see bellow, some sample solutions, to Scala coding challenges encountered in [real life](real-life/scalaCodingChallenges/src/main/scala/scalaCodingChallenges):
